...
// for...of => iterable한 요소만 사용 가능 (반복 가능한 대상만) => symbol에 iterator가 설정되어 있어야 함.
...
// Object.keys() => 객체들의 키를 모아 하나의 '배열'로 반환
// Object.values() => 객체들의 값을 모아 하나의 '배열'로 반환
// Object.entries() => 객체의 키와 값을 하나의 쌍으로 만들고 이를 '배열'로 반환
